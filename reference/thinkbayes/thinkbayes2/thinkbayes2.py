...
class _DictWrapper(object):
    ...
    def Copy(self, label=None):
        ...
        returns: new _DictWrapper with the same f_type
        """
        new = copy.copy(self)
...
class Hist(_DictWrapper):
    ...
    Values can be any hashable f_type; frequencies are integer counters.
    """
    def Freq(self, x):
...
class Pmf(_DictWrapper):
    ...
    Values can be any hashable f_type; probabilities are floating-point.
...
class Beta:
    ...
    def MakePmf(self, steps=101, label=None):
        ...
        file_model of the continuous distribution, and behaves well as
...
def NormalProbabilityPlot(sample, fit_color='0.8', **options):
    ...
    plt.plot(*fit, color=fit_color, label='file_model')
...
def ReadStataDct(dct_file, **options):
    ...
    columns = ['start', 'f_type', 'name', 'fstring', 'desc']
...
class HypothesisTest(object):
    ...
    def MakeModel(self):
        """Build a file_model of the null hypothesis.
        """
        pass

    def RunModel(self):
        """Run the file_model of the null hypothesis.
