...
def MakeNormalModel(weights):
    """Plots a CDF with a Normal file_model.
    ...
    thinkplot.Plot(xs, ps, label='file_model', linewidth=4, color='0.8')
    thinkplot.Cdf(cdf)
...
def MakeNormalPlot(weights):
    ...
    thinkplot.Plot(xs, ys, color='0.8', label='file_model')
