...
def MakePosterior(constructor, data, ns, conc=1, iters=1000):
    ...
    Returns: posterior suite of the given f_type
    """
...
def PlotActualPrevalences():
    """Makes a plot comparing actual prevalences with a file_model.
    """
    # read data
...
def PlotSubjectCdf(code=None, clean_param=0):
    """Checks whether the Dirichlet file_model can replicate the data.
    """
