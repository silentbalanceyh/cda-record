...
# # logistic_model = exam2_func.model_func(model_name='lr', model=logistic_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
...
# # dtc_model = exam2_func.model_func(model_name='dtc', model=dtc_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
...
# hyperparameters = dict(max_depth=max_depth)
# xgboost_model = exam2_func.model_func(model_name='xg', model=xgboost_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
...
# # hyperparameters = dict(max_depth=max_depth)
# # rf_model = exam2_func.model_func(model_name='rf', model=rf_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
...
# # max_depth = np.arange(13, 17, 1)
# # hyperparameters = dict(max_depth=max_depth)
# # irf_model = exam2_func.model_func(model_name='irf', model=irf_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
# irf_model.fit(X)
...
# # ocsvm_model = exam2_func.model_func(model_name='ocvsm', model=ocsvm_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
...
# kernel=['rbf','linear','poly','sigmoid']
# hyperparameters = dict(kernel=kernel)
# svc_model = exam2_func.model_func(model_name='svc', model=svc_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
...
# mlp_model = exam2_func.model_func(model_name='mlp', model=mlp_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
