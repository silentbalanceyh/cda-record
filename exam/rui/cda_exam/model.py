...
# # logistic_model = func.model_func(model_name='lr', file_model=logistic_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
...
# # dtc_model = func.model_func(model_name='dtc', file_model=dtc_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
...
# # hyperparameters = dict(max_depth=max_depth)
# # xgboost_model = func.model_func(model_name='xg', file_model=xgboost_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
...
# # hyperparameters = dict(max_depth=max_depth)
# # rf_model = func.model_func(model_name='rf', file_model=rf_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
...
# # svc_model = func.model_func(model_name='svc', file_model=svc_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
...
# # mlp_model = func.model_func(model_name='mlp', file_model=mlp_model, param_dict=hyperparameters, x_train=train_X, y_train=train_y)
